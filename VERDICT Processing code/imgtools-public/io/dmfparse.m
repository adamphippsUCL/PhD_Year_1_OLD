...
for ifile = 1:length(ffn)
    ...
    for id = 1:nd
        ...
        if isfield(fg,'Private_2005_140f') && isstruct(fg.Private_2005_140f)
        ...
        if isfield(fg,'Private_2005_140f') && isstruct(fg.Private_2005_140f) % not struct from XNAT VERDICT
