...
%  Accompanies the "Geometry in Medical Imaging" paper
%  See also Python version.
%
%  Edit the fpath to point to folder with the Dicom files.
%
...
% Path to DICOM files:
% fpath = '/Users/davidatkinson/OneDrive - University College London/data/20191211-geometryIngenia/DICOM';
...
%  Commentd code provided for sorting slices.
% 
...
[V, spatialInfo, sliceDim] = dicomreadVolume(ffn) ;
