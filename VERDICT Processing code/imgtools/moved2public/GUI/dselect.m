...
%
%      Param can be 'ismodal', 'name', or 'xxonly'
%
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if ispref('dselect','dir')
    defdir = getpref('dselect','dir');
else
    defdir = [] ;
end
...
if folder_name == 0
    ...
    setpref('dselect','dir',folder_name)
end
...
attrn = {'SeriesNumber','ProtocolName'} ;
...
SOPClassUIDs = {'all', EMR, RAW, SCC, GPS, PDS, PEC } ;
