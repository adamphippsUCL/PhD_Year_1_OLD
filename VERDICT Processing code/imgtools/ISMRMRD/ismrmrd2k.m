function ksp = ismrmrd2k(varargin)
% ISMRMRD2K Convert ISMRMRD file to k-space for BART
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
filename = pref_uigetfile('ismrmrd2k','filename',varargin{:}) ;
...
if nContrasts > 1
    warning(['Only handles 1 contrast correctly'])
end
if nReps > 1
    warning(['Only handles correctly 1 rep.'])
end
if nSlices > 1
    warning(['Only handles correctly 1 slice (will do 3D).'])
end
