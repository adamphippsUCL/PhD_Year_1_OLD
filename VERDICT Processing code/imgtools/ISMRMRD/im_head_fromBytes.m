function obj = im_head_fromBytes(bytearray)
% im_head_fromBytes Convert from a byte array to an ISMRMRD ImageHeader
% This conforms to the memory layout of the C-struct
%
%   hdr = im_head_fromBytes(bytearray)
%
%  bytearray  [198 N]
%
% Adapted by D. Atkinson from ISMRMRD ImageHeader.m
%
