...
% For Future   encodedSpace  reconSpace
% pixels in encodedSpace
encdx = encodedSpace.fieldOfView.x / encodedSpace.matrixSize.x ;
encdy = encodedSpace.fieldOfView.y / encodedSpace.matrixSize.y ;
